...
## [1.1.4]
### Uncategorized
- fix: Allow the metamask.github.io to call the snap ([#151](https://github.com/MetaMask/snap-simple-keyring/pull/151))
- fix: moved build-preinstalled-snap.js script inside snap package ([#150](https://github.com/MetaMask/snap-simple-keyring/pull/150))
