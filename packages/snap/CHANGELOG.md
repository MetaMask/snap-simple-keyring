...
## [1.1.1]
### Uncategorized
- fix: update eth-sig-util to fix a regression ([#131](https://github.com/MetaMask/snap-simple-keyring/pull/131))
- chore: remove unused `snap_dialog` permission ([#127](https://github.com/MetaMask/snap-simple-keyring/pull/127))
