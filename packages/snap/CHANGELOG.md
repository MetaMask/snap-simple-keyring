...
## [1.1.0]
### Uncategorized
- fix: remove `localhost` from `allowedOrigin` ([#125](https://github.com/MetaMask/snap-simple-keyring/pull/125))
- feat: add logger utility ([#116](https://github.com/MetaMask/snap-simple-keyring/pull/116))
- fix: sanitize error message when importing invalid private key ([#119](https://github.com/MetaMask/snap-simple-keyring/pull/119))
