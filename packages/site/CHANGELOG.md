...
## [2.1.0]
### Uncategorized
- chore: use new font Geist ([#172](https://github.com/MetaMask/snap-simple-keyring/pull/172))
- chore: bump accounts dependencies ([#169](https://github.com/MetaMask/snap-simple-keyring/pull/169))
...
[2.1.0]: https://github.com/MetaMask/snap-simple-keyring/compare/v2.0.0...v2.1.0
