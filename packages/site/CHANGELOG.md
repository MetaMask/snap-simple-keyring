...
## [1.1.0]
### Uncategorized
- build: remove cache before building site ([#124](https://github.com/MetaMask/snap-simple-keyring/pull/124))
- ui: add parenthesis around details of the Snap version ([#123](https://github.com/MetaMask/snap-simple-keyring/pull/123))
- ui: move "Delete" button into account details ([#122](https://github.com/MetaMask/snap-simple-keyring/pull/122))
- ui: move "Delete" button into account details ([#121](https://github.com/MetaMask/snap-simple-keyring/pull/121))
- fix: use `stretch` as default alignment in `AccountRow` ([#120](https://github.com/MetaMask/snap-simple-keyring/pull/120))
- feat: add delete button to account ([#117](https://github.com/MetaMask/snap-simple-keyring/pull/117))
- feat: add "Update Account" to companion dapp ([#118](https://github.com/MetaMask/snap-simple-keyring/pull/118))
- fix: change `packageInfo` to `snapPackageInfo` ([#114](https://github.com/MetaMask/snap-simple-keyring/pull/114))
- fix: use the Snap `package.json` for the update check ([#112](https://github.com/MetaMask/snap-simple-keyring/pull/112))
